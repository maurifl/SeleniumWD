...
public class UpLoadFiles {
    ...
    public void TestTutorial() throws InterruptedException {
        ...
        //************************************************************************************************
        //INPUTS
        WebElement nombre = driver.findElement(By.id("wsf-1-field-80"));
        nombre.clear();
        nombre.sendKeys("Dante Mauricio");

        WebElement apellido = driver.findElement(By.id("wsf-1-field-81"));
        apellido.clear();
        apellido.sendKeys("Fontana Laplagne");

        WebElement mail = driver.findElement(By.id("wsf-1-field-82"));
        mail.clear();
        mail.sendKeys("maurifl@gmail.com");

        WebElement tel = driver.findElement(By.id("wsf-1-field-83"));
        tel.clear();
        tel.sendKeys("2645152222");

        WebElement dir = driver.findElement(By.id("wsf-1-field-84"));
        dir.clear();
        dir.sendKeys("Lima 336 B° Hualilán 1 Rawson San Juan");

        //************************************************************************************************
        //CHECKBOX - CHECK
        WebElement php = driver.findElement(By.id("wsf-1-label-85-row-1"));
        Thread.sleep(500);
        php.click();

        WebElement py = driver.findElement(By.id("wsf-1-label-85-row-2"));
        Thread.sleep(500);
        py.click();

        WebElement js = driver.findElement(By.id("wsf-1-label-85-row-3"));
        Thread.sleep(500);
        js.click();
        ...
        //RADIO BUTTONS
        Thread.sleep(500);
        WebElement cy = driver.findElement(By.id("wsf-1-label-86-row-1"));
        cy.isDisplayed();
        cy.isEnabled();
        if (!cy.isSelected()) {
            cy.click();
        ...
        Thread.sleep(500);
        WebElement wd = driver.findElement(By.id("wsf-1-label-86-row-2"));
        wd.isDisplayed();
        wd.isEnabled();
        ...
        Thread.sleep(500);
        WebElement se = driver.findElement(By.id("wsf-1-label-86-row-3"));
        se.isDisplayed();
        se.isEnabled();
        ...
        //************************************************************************************************
        //COMBOBOX
        WebElement cb = driver.findElement(By.id("wsf-1-field-87"));
        Select CBox= new Select(cb);
        WebElement cb1=driver.findElement(By.id("wsf-1-field-88"));
        ...
        WebElement cb2 = driver.findElement(By.id("wsf-1-field-89"));
        ...
        WebElement cb3 = driver.findElement(By.id("wsf-1-field-90"));
        ...
        //************************************************************************************************
        //Calendar
        WebElement dt=driver.findElement(By.id("wsf-1-field-91"));
        dt.sendKeys("30092023");
        WebElement dt1= driver.findElement(By.id("wsf-1-field-92"));
        dt1.sendKeys("30092023");

        //************************************************************************************************
        //UpLoadFiles
        WebElement upload= driver.findElement(By.id("wsf-1-field-94"));
        upload.sendKeys("C:\\Users\\SkyNet\\Desktop\\SELENIUM WEB\\ProjIntellijSeleniumMaben\\src\\test\\java\\img\\cuadro.jpg");
        Thread.sleep(1000);

        //************************************************************************************************
        //BUTTON
        WebElement submit = driver.findElement(By.id("wsf-1-field-93"));
        submit.click();
    }
